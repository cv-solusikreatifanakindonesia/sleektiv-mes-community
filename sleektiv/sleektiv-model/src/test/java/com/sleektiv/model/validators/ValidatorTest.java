 ...
 * ***************************************************************************
 */
package com.sleektiv.model.validators;
...
import com.sleektiv.model.beans.sample.CustomEntityService;
import com.sleektiv.model.beans.sample.SampleSimpleDatabaseObject;
import com.sleektiv.model.internal.DataAccessTest;
...
public class ValidatorTest extends DataAccessTest {
    ...
    public void shouldHasErrorMessage() throws Exception {
        ...
        assertEquals("sleektivView.validate.field.error.missing", entity.getError("age").getMessage());
    ...
    public void shouldIgnoreUnscaledValueValidatorForStringValue() throws Exception {
        // given
        Entity entity = new DefaultEntity(dataDefinition);
        entity.setField("name", "Sleektiv Framework RLZ!");
    ...
    public void shouldHaveErrorIfCustomValidatorReturnsFalse() throws Exception {
        ...
        assertFalse(entity.isValid());
        assertEquals(1, entity.getErrors().size());
        assertEquals("sleektivView.validate.field.error.custom", entity.getError("name").getMessage());
        assertEquals(0, entity.getGlobalErrors().size());
    }
    ...
    public void shouldHaveNoErrorsIfStringMatchExpression() throws Exception {
        ...
        fieldDefinitionName.withValidator(new RegexValidator("^Sleektiv.*"));
