...
public class CustomValidatorTest {
    ...
    private static final String DEFAULT_MSG = "sleektivView.validate.field.error.custom";

    private static final String CUSTOM_MSG = "sleektiv.testing.custom.field.error.message";
