...
import com.sleektiv.model.internal.DataAccessServiceImpl;
...
public class OmitModelCreateHooksAspectTest {
    ...
    public final void checkCopyEntityPointcutDefinition() throws NoSuchMethodException {
        ...
        assertEquals("com.sleektiv.model.internal.DataAccessServiceImpl", clazz.getCanonicalName());
        assertEquals("com.sleektiv.model.internal.api.InternalDataDefinition", InternalDataDefinition.class.getCanonicalName());
    ...
    public final void checkCallCreateHookPointcutDefinition() throws NoSuchMethodException {
        ...
        assertEquals("com.sleektiv.model.internal.api.InternalDataDefinition", clazz.getCanonicalName());
        assertEquals("com.sleektiv.model.api.Entity", Entity.class.getCanonicalName());
