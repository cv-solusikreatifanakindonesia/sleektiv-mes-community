 ...
 * ***************************************************************************
 */
package com.sleektiv.model.internal.hbmconverter;
...
import com.sleektiv.model.internal.api.ModelXmlToHbmConverter;
...
public class ModelXmlToHbmConverterTest {
    ...
    public void shouldCreateNameMergingPluginAndEntityNames() throws Exception {
        assertNodeEquals("com.sleektiv.model.beans.full.FullFirstEntity", "/hibernate-mapping/class[1]/@name", hbmFirstEntity);
        assertNodeEquals("com.sleektiv.model.beans.full.FullSecondEntity", "/hibernate-mapping/class[1]/@name", hbmSecondEntity);
        assertNodeEquals("com.sleektiv.model.beans.full.FullThirdEntity", "/hibernate-mapping/class[1]/@name", hbmThirdEntity);
    }
    ...
    public void shouldDefineBelongsToRelation() throws Exception {
        ...
        assertNodeEquals("com.sleektiv.model.beans.other.OtherSecondEntity",
    ...
    public void shouldDefineHasManyRelation() throws Exception {
        ...
        assertNodeExists("/hibernate-mapping/class[1]/set[@inverse='true']", hbmFirstEntity);
        assertNodeEquals("com.sleektiv.model.beans.full.FullSecondEntity",
                "/hibernate-mapping/class[1]/set[@name='fieldTree']/one-to-many/@class", hbmFirstEntity);
        assertNodeEquals("com.sleektiv.model.beans.full.FullThirdEntity",
