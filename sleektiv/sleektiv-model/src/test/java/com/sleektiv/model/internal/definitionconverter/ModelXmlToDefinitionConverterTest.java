 ...
 * ***************************************************************************
 */
package com.sleektiv.model.internal.definitionconverter;
...
import com.sleektiv.model.CustomHook;
import com.sleektiv.model.TransactionMockAwareTest;
import com.sleektiv.model.Utils;
import com.sleektiv.model.api.DataDefinition;
import com.sleektiv.model.api.FieldDefinition;
import com.sleektiv.model.api.types.BelongsToType;
import com.sleektiv.model.api.types.HasManyType;
import com.sleektiv.model.api.types.ManyToManyType;
import com.sleektiv.model.api.types.TreeType;
import com.sleektiv.model.internal.DataDefinitionImpl;
import com.sleektiv.model.internal.DataDefinitionServiceImpl;
import com.sleektiv.model.internal.FieldDefinitionImpl;
import com.sleektiv.model.internal.api.DataAccessService;
...
import com.sleektiv.model.internal.api.ModelXmlToClassConverter;
import com.sleektiv.model.internal.classconverter.ModelXmlToClassConverterImpl;
import com.sleektiv.model.internal.types.BelongsToEntityType;
import com.sleektiv.model.internal.types.BooleanType;
import com.sleektiv.model.internal.types.DateTimeType;
import com.sleektiv.model.internal.types.DateType;
import com.sleektiv.model.internal.types.DecimalType;
import com.sleektiv.model.internal.types.DictionaryType;
import com.sleektiv.model.internal.types.EnumType;
import com.sleektiv.model.internal.types.HasManyEntitiesType;
import com.sleektiv.model.internal.types.IntegerType;
import com.sleektiv.model.internal.types.PasswordType;
import com.sleektiv.model.internal.types.PriorityType;
import com.sleektiv.model.internal.types.StringType;
import com.sleektiv.model.internal.types.TextType;
import com.sleektiv.model.internal.types.TreeEntitiesType;
import com.sleektiv.model.internal.validators.CustomEntityValidator;
import com.sleektiv.model.internal.validators.CustomValidator;
import com.sleektiv.model.internal.validators.LengthValidator;
import com.sleektiv.model.internal.validators.RangeValidator;
import com.sleektiv.model.internal.validators.RegexValidator;
import com.sleektiv.model.internal.validators.RequiredValidator;
import com.sleektiv.model.internal.validators.ScaleValidator;
import com.sleektiv.model.internal.validators.UniqueValidator;
import com.sleektiv.model.internal.validators.UnscaledValueValidator;
...
public class ModelXmlToDefinitionConverterTest extends TransactionMockAwareTest {
    ...
    public void shouldSetDataDefinitionAttributes() {
        ...
        assertEquals("com.sleektiv.model.beans.full.FullFirstEntity", dataDefinition.getFullyQualifiedClassName());
        assertEquals("com.sleektiv.model.beans.full.FullFirstEntity", dataDefinition.getInstanceForEntity().getClass()
                .getCanonicalName());
        assertEquals("full", dataDefinition.getPluginIdentifier());
        assertEquals("com.sleektiv.model.beans.full.FullFirstEntity", dataDefinition.getClassForEntity().getCanonicalName());
