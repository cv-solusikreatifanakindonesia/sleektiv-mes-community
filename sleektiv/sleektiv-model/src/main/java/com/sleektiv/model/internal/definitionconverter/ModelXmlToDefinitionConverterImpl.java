...
import com.sleektiv.model.api.types.Cascadeable;
import com.sleektiv.model.api.types.FieldType;
import com.sleektiv.model.constants.VersionableConstants;
import com.sleektiv.model.internal.AbstractModelXmlConverter;
import com.sleektiv.model.internal.DataDefinitionImpl;
import com.sleektiv.model.internal.FieldDefinitionImpl;
import com.sleektiv.model.internal.MasterModel;
import com.sleektiv.model.internal.api.*;
import com.sleektiv.model.internal.hooks.EntityHookDefinitionImpl;
import com.sleektiv.model.internal.hooks.FieldHookDefinitionImpl;
import com.sleektiv.model.internal.hooks.HookInitializationException;
import com.sleektiv.model.internal.types.*;
import com.sleektiv.model.internal.utils.ClassNameUtils;
import com.sleektiv.model.internal.validators.*;
...
import static com.sleektiv.model.internal.AbstractModelXmlConverter.FieldsTag.PRIORITY;
import static com.sleektiv.model.internal.AbstractModelXmlConverter.OtherTag.IDENTIFIER;
import static com.sleektiv.model.internal.AbstractModelXmlConverter.OtherTag.MASTERMODEL;
...
public final class ModelXmlToDefinitionConverterImpl extends AbstractModelXmlConverter implements ModelXmlToDefinitionConverter {
    ...
    static class PluginIdentifierInjectionAspect {
        ...
        @Pointcut("execution((com.sleektiv.model.internal.api.EntityHookDefinition || com.sleektiv.model.internal.api.FieldHookDefinition) ModelXmlToDefinitionConverterImpl.*(javax.xml.stream.XMLStreamReader, String)) && args(reader, *)")
        public void execHookDefinitionGetter(final XMLStreamReader reader) {
        }

        @Pointcut("execution(com.sleektiv.model.api.FieldDefinition ModelXmlToDefinitionConverterImpl.getFieldDefinition(javax.xml.stream.XMLStreamReader, com.sleektiv.model.internal.DataDefinitionImpl, com.sleektiv.model.internal.AbstractModelXmlConverter.FieldsTag)) && args(reader, ..)")
