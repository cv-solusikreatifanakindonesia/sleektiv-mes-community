...
public final class RequiredValidator implements FieldHookDefinition, ErrorMessageDefinition {
    ...
    private static final String MISSING_ERROR = "sleektivView.validate.field.error.missing";

    private static final String MISSING_RELATION_ERROR = "sleektivView.validate.field.error.missingRelation";
