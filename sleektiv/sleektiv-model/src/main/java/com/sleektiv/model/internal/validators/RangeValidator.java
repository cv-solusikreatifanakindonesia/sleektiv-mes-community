...
public final class RangeValidator implements FieldHookDefinition, ErrorMessageDefinition {
    ...
    private static final String OUT_OF_RANGE_ERROR_SMALL = "sleektivView.validate.field.error.outOfRange.toSmall";

    private static final String OUT_OF_RANGE_ERROR_LARGE = "sleektivView.validate.field.error.outOfRange.toLarge";
