...
import com.sleektiv.model.api.types.*;
        ...
        if (value != null) {
            ...
            if (value instanceof String) {
                try {
                    ...
                    validatedEntity.addError(fieldDefinition, "sleektivView.validate.field.error.wrongType", value.getClass()
    ...
    private void validateEntityAgainstVersion(final Entity databaseEntity, final Entity entity, final DataDefinition dataDefinition) {
        if(databaseEntity != null && dataDefinition.isVersionable()){
            ...
            if(savedVersion.compareTo(currentDbVersion) != 0){
                entity.addGlobalError("sleektivView.validate.global.optimisticLock",false, true);
            }
        }
    }
}
