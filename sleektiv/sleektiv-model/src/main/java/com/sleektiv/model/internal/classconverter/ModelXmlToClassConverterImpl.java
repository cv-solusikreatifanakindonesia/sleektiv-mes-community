 ...
 * ***************************************************************************
 */
package com.sleektiv.model.internal.classconverter;
...
public final class ModelXmlToClassConverterImpl extends AbstractModelXmlConverter implements ModelXmlToClassConverter,
    ...
    public ModelXmlToClassConverterImpl() {
        ...
        classPool.appendClassPath(new ClassClassPath(com.sleektiv.model.internal.classconverter.SleektivModelBean.class));
    }
    ...
    private void parse(final XMLStreamReader reader, final CtClass ctClass, final String pluginIdentifier)
        ...
        ctClass.addInterface(classPool.get(SleektivModelBean.class.getName()));
    ...
    private void getFieldsDeepHashCode(final StringBuilder sb, final List<String> fieldNames) {
        for (String fieldName : fieldNames) {
            ...
            sb.append("if (fieldValue instanceof com.sleektiv.model.internal.classconverter.SleektivModelBean) {");
            sb.append("    result += prime * result + ((com.sleektiv.model.internal.classconverter.SleektivModelBean) fieldValue).flatHashCode();");
            ...
            sb.append("           result += prime * result + "
                    + "(collectionElement instanceof com.sleektiv.model.internal.classconverter.SleektivModelBean ? "
                    + "((com.sleektiv.model.internal.classconverter.SleektivModelBean) collectionElement).flatHashCode() : "
    ...
    private void getFieldsFlatHashCode(final StringBuilder sb, final List<String> fieldNames) {
        for (String fieldName : fieldNames) {
            ...
            sb.append("   if (fieldValue instanceof com.sleektiv.model.internal.classconverter.SleektivModelBean) {");
            sb.append("      Object relatedEntityId = ((com.sleektiv.model.internal.classconverter.SleektivModelBean) fieldValue).getId();");
