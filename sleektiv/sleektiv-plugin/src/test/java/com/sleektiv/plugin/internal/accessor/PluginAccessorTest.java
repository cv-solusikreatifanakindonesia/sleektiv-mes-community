...
public class PluginAccessorTest {
    ...
    public void shouldSynchronizePluginsFromClasspathAndDatabase() throws Exception {
        ...
        SleektivPluginPlugin pluginsPlugin1 = mock(SleektivPluginPlugin.class);
        ...
        SleektivPluginPlugin pluginsPlugin21 = mock(SleektivPluginPlugin.class);
        ...
        SleektivPluginPlugin pluginsPlugin4 = mock(SleektivPluginPlugin.class);
        ...
        Set<SleektivPluginPlugin> pluginsFromDatabase = Sets.newHashSet(pluginsPlugin1, pluginsPlugin21, pluginsPlugin4);
    ...
    public void shouldListAllPlugins() throws Exception {
        ...
        SleektivPluginPlugin pluginsPlugin1 = mock(SleektivPluginPlugin.class, "plugin1");
        given(plugin1.getIdentifier()).willReturn("identifier1");
        given(pluginsPlugin1.getIdentifier()).willReturn("identifier1");
        given(pluginsPlugin1.getVersion()).willReturn("0.0.0");
        given(plugin1.compareVersion(new Version(pluginsPlugin1.getVersion()))).willReturn(0);
        ...
        SleektivPluginPlugin pluginsPlugin21 = mock(SleektivPluginPlugin.class, "plugin21");
        given(pluginsPlugin21.getIdentifier()).willReturn("identifier21");
        given(pluginsPlugin21.getState()).willReturn("ENABLED");
        ...
        SleektivPluginPlugin pluginsPlugin3 = mock(SleektivPluginPlugin.class, "plugin3");
        given(plugin3.getIdentifier()).willReturn("identifier3");
        ...
        Set<SleektivPluginPlugin> pluginsFromDatabase = Sets.newHashSet(pluginsPlugin1, pluginsPlugin21, pluginsPlugin3);
    ...
    public void shouldFailOnPluginDowngrade() throws Exception {
        ...
        SleektivPluginPlugin pluginsPlugin12 = mock(SleektivPluginPlugin.class);
        ...
        Set<SleektivPluginPlugin> pluginsFromDatabase = Sets.newHashSet(pluginsPlugin12);
    ...
    public void shouldPerformInit() throws Exception {
        ...
        SleektivPluginPlugin pluginsPlugin2 = mock(SleektivPluginPlugin.class, "plugin2");
        ...
        Set<SleektivPluginPlugin> pluginsFromDatabase = Sets.newHashSet(pluginsPlugin1, pluginsPlugin2);
    ...
    public void shouldPerformEnableOnEnablingPlugins() throws Exception {
        ...
        SleektivPluginPlugin pluginsPlugin2 = mock(SleektivPluginPlugin.class);
        given(plugin2.getIdentifier()).willReturn("identifier2");
        given(pluginsPlugin2.getIdentifier()).willReturn("identifier2");
        ...
        InternalPlugin plugin3 = mock(InternalPlugin.class);
        SleektivPluginPlugin pluginsPlugin3 = mock(SleektivPluginPlugin.class);
        given(pluginsPlugin3.getIdentifier()).willReturn("identifier3");
        given(pluginsPlugin3.getVersion()).willReturn("0.0.0");
        ...
        Set<SleektivPluginPlugin> pluginsFromDatabase = Sets.newHashSet(pluginsPlugin1, pluginsPlugin2, pluginsPlugin3);
        List<Plugin> sortedPluginsToInitialize = Lists.newArrayList((Plugin) plugin2, (Plugin) plugin1);
    ...
    public void shouldRemovePlugin() throws Exception {
        ...
        given(pluginDao.list()).willReturn(Sets.<SleektivPluginPlugin> newHashSet(pluginsPlugin1, pluginsPlugin2));
    ...
    public void shouldSaveNewPlugin() throws Exception {
        ...
        given(pluginDao.list()).willReturn(Sets.<SleektivPluginPlugin> newHashSet(pluginsPlugin1));
    ...
    public void shouldSaveExistingPlugin() throws Exception {
        ...
        given(pluginDao.list()).willReturn(Sets.<SleektivPluginPlugin> newHashSet(pluginsPlugin2));
