...
public class PluginDaoTest {
    ...
    private final SleektivPluginPlugin plugin1 = new SleektivPluginPlugin();

    private final SleektivPluginPlugin plugin2 = new SleektivPluginPlugin();
    ...
    public void init() {
        ...
        given(session.createCriteria(SleektivPluginPlugin.class)).willReturn(criteria);
    ...
    public void shouldSaveNotPersistentPlugin() throws Exception {
        ...
        verify(session).save(any(SleektivPluginPlugin.class));
    }
    ...
    public void shouldListPlugin() throws Exception {
        ...
        // when
        Set<SleektivPluginPlugin> plugins = pluginDao.list();
