 ...
 * ***************************************************************************
 */
package com.sleektiv.model.beans.sleektivPlugin;
...
@Entity
@Table(name = "sleektivplugin_plugin")
public class SleektivPluginPlugin {

    @SequenceGenerator(name="ID_GEN", sequenceName="sleektivplugin_plugin_id_seq")
    ...
    public SleektivPluginPlugin() {
        // empty
    }

    public SleektivPluginPlugin(final Plugin plugin) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof SleektivPluginPlugin)) {
            return false;
        }
        SleektivPluginPlugin other = (SleektivPluginPlugin) obj;
        if (id == null) {
            if (other.id != null) {
                return false;
            }
