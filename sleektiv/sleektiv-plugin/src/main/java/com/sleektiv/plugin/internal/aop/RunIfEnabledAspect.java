 ...
 * ***************************************************************************
 */
package com.sleektiv.plugin.internal.aop;

import static com.sleektiv.plugin.api.PluginUtils.isEnabled;
...
public class RunIfEnabledAspect {
    ...
    @Around("(execution(* *(..)) || (adviceexecution() && !args(org.aspectj.lang.ProceedingJoinPoint, ..))) && @within(annotation) && !@annotation(com.sleektiv.plugin.api.RunIfEnabled)")
    ...
    @Around("adviceexecution() && args(innerPjp, ..) && @within(annotation) && !@annotation(com.sleektiv.plugin.api.RunIfEnabled)")
