...
import static com.sleektiv.customTranslation.constants.CustomTranslationFields.ACTIVE;
...
public class CustomTranslationManagementServiceImpl implements CustomTranslationManagementService {
    ...
    public void addCustomTranslations(final String pluginIdentifier, final String locale, final Map<String, String> translations) {
        ...
        List<String> existingKeys = currentSession
                .createQuery(
                        "SELECT key FROM com.sleektiv.model.beans.sleektivCustomTranslation.SleektivCustomTranslationCustomTranslation "
    ...
    public void removeCustomTranslations(final String pluginIdentifier) {
        ...
        currentSession
                .createQuery(
                        "UPDATE com.sleektiv.model.beans.sleektivCustomTranslation.SleektivCustomTranslationCustomTranslation "
