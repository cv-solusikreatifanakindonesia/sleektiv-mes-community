...
import com.sleektiv.localization.internal.TranslationServiceImpl;
...
public class TranslationServiceOverrideAspectTest {
    ...
    public final void checkTranslateWithErrorExecutionPointcutDefinition() throws NoSuchMethodException {
        ...
        assertEquals("com.sleektiv.localization.internal.TranslationServiceImpl", clazz.getCanonicalName());
