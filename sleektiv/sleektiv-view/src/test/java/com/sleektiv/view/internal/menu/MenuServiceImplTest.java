...
import com.sleektiv.view.internal.api.ViewDefinitionService;
...
import com.sleektiv.view.internal.security.SecurityViewDefinitionRoleResolver;
...
public class MenuServiceImplTest {
    ...
    public final void shouldCreateItem() {
        ...
        given(menuCrudService.createEntity(SleektivViewConstants.MODEL_ITEM)).willAnswer(new Answer<Entity>() {
    ...
    public final void shouldCreateCategory() {
        ...
        given(menuCrudService.createEntity(SleektivViewConstants.MODEL_CATEGORY)).willAnswer(new Answer<Entity>() {
    ...
    public final void shouldCreateViewForViewItem() {
        ...
        given(menuCrudService.createEntity(SleektivViewConstants.MODEL_VIEW)).willAnswer(new Answer<Entity>() {
