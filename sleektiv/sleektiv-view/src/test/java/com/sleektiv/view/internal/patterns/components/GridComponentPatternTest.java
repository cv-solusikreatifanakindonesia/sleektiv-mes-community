 ...
 * ***************************************************************************
 */
package com.sleektiv.view.internal.patterns.components;
...
import com.sleektiv.view.internal.api.InternalViewDefinitionState;
import com.sleektiv.view.internal.components.TextInputComponentPattern;
import com.sleektiv.view.internal.components.grid.GridComponentColumn;
import com.sleektiv.view.internal.components.grid.GridComponentPattern;
import com.sleektiv.view.internal.module.gridColumn.ViewGridColumnModuleColumnModel;
import com.sleektiv.view.internal.patterns.AbstractComponentPattern;
import com.sleektiv.view.internal.patterns.AbstractPatternTest;
import com.sleektiv.view.internal.xml.ViewDefinitionParser;
import com.sleektiv.view.internal.xml.ViewDefinitionParserImpl;
...
public class GridComponentPatternTest extends AbstractPatternTest {
    ...
    public void shouldInitializeOptions() throws Exception {
        ...
        ComponentDefinition componentDefinition = getComponentDefinition(SleektivViewConstants.L_GRID, viewDefinition);
    ...
    public void shouldHaveScopeFieldName() throws Exception {
        ...
        ComponentDefinition componentDefinition = getComponentDefinition(SleektivViewConstants.L_GRID, null, "#{component}.field", null, viewDefinition);
        componentDefinition.setTranslationService(translationService);
        componentDefinition.setApplicationContext(applicationContext);
        GridComponentPattern pattern = new GridComponentPattern(componentDefinition);
