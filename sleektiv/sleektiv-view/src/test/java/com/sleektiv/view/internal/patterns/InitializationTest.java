...
public class InitializationTest extends AbstractPatternTest {
    ...
    public void shouldInitializeAllComponents() throws Exception {
        ...
        AbstractContainerPattern form = new FormComponentPattern(getComponentDefinition(SleektivViewConstants.L_FORM, null, null, parent,
                viewDefinition));
        ...
        AbstractComponentPattern grid = new TextInputComponentPattern(getComponentDefinition(SleektivViewConstants.L_GRID, null,
