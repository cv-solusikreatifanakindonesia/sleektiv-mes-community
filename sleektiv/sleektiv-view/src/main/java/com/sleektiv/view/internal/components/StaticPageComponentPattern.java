...
public final class StaticPageComponentPattern extends AbstractComponentPattern {
    ...
    protected Map<String, Object> getJspOptions(final Locale locale) {
        ...
        translationsMap.put("sleektivView.fileupload.dropzone", getTranslationService().translate("sleektivView.fileupload.dropzone",
                locale, "" + getTranslationService().getMaxUploadSize()));
        translationsMap.put("sleektivView.errorPage.error.uploadException.maxSizeExceeded.explanation",
                getTranslationService().translate("sleektivView.errorPage.error.uploadException.maxSizeExceeded.explanation",
                        locale, "" + getTranslationService().getMaxUploadSize()));
