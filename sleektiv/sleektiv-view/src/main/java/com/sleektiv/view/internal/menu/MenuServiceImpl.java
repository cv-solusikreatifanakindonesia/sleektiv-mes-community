...
import com.sleektiv.view.internal.menu.items.UrlMenuItem;
import com.sleektiv.view.internal.menu.items.ViewDefinitionMenuItemItem;
...
public final class MenuServiceImpl implements InternalMenuService {
    ...
    public void addView(final MenuItemDefinition itemDefinition) {
        ...
        menuView = menuCrudService.createEntity(SleektivViewConstants.MODEL_VIEW);
    ...
    public void createCategory(final MenuCategoryDefinition menuCategoryDefinition) {
        ...
        menuCategory = menuCrudService.createEntity(SleektivViewConstants.MODEL_CATEGORY);
    ...
    public void createItem(final MenuItemDefinition itemDefinition) {
        ...
        if (menuItem == null) {
            menuItem = menuCrudService.createEntity(SleektivViewConstants.MODEL_ITEM);
