...
import com.sleektiv.view.internal.internal.EntityIdChangeListenerHolder;
import com.sleektiv.view.internal.internal.EventHandlerHolder;
import com.sleektiv.view.internal.internal.MessageHolder;
...
public abstract class AbstractComponentState implements InternalComponentState, FieldEntityIdChangeListener,
    ...
    protected String translateMessage(final String key, final String... args) {
        return getTranslationService()
                .translate(getTranslationPath() + "." + key, "sleektivView.message." + key, getLocale(), args);
    }
