 ...
 * ***************************************************************************
 */
package com.sleektiv.view.internal.components.grid;
...
import com.sleektiv.model.api.types.EnumeratedType;
...
import com.sleektiv.view.constants.Alignment;
import com.sleektiv.view.internal.ComponentDefinition;
import com.sleektiv.view.internal.ComponentOption;
import com.sleektiv.view.internal.CriteriaModifier;
import com.sleektiv.view.internal.RowStyleResolver;
...
public class GridComponentPattern extends AbstractComponentPattern {
    ...
    protected JSONObject getJsOptions(final Locale locale) throws JSONException {
        ...
        translations.put("loading", getTranslationService().translate("sleektivView.loading", locale));
    ...
    private void addTranslation(final JSONObject translation, final String key, final Locale locale) throws JSONException {
        translation.put(key,
                getTranslationService().translate(getTranslationPath() + "." + key, "sleektivView.grid." + key, locale));
    }
    ...
    private JSONArray getFilterValuesForColumn(final GridComponentColumn column, final Locale locale) throws JSONException {
        ...
        if (fieldDefinition.getType() instanceof EnumeratedType) {
            ...
            obj1.put("key", "1");
            obj1.put("value", getTranslationService().translate("sleektivView.true", locale));
            ...
            obj0.put("key", "0");
            obj0.put("value", getTranslationService().translate("sleektivView.false", locale));
