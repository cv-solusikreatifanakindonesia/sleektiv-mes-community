...
import com.sleektiv.view.api.LogoComponent;
import com.sleektiv.view.internal.api.ViewDefinitionService;
import com.sleektiv.view.internal.menu.MenuService;
...
public final class MainController {
    ...
    public ModelAndView getMainView(@RequestParam final Map<String, String> arguments, final Locale locale) {
        ...
        mav.setViewName("sleektivView/main");
    ...
    public ModelAndView getStartViewWhenNoDashboard(@RequestParam final Map<String, String> arguments, final Locale locale) {
        ...
        mav.setViewName("sleektivView/noDashboard");
