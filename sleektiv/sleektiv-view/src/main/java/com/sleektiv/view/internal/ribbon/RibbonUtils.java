        ...
        for (int i = 0; i < json.getJSONArray("groups").length(); i++) {
            ...
            group.put(
                    ...
                    pattern.getTranslationService().translate(pattern.getTranslationPath() + ".ribbon." + group.getString(NAME),
                            "sleektivView.ribbon." + group.getString(NAME), locale));
        ...
        if (owner.has("items")) {
            for (int j = 0; j < owner.getJSONArray("items").length(); j++) {
                ...
                String label = pattern.getTranslationService().translate(
                        ...
                        "sleektivView.ribbon." + prefix + item.getString(NAME), locale);
                ...
                if (item.has("message")) {
                    ...
                    if (message.contains(".")) {
                        ...
                        message = pattern.getTranslationService().translate("sleektivView.message." + message, locale);
                    }
