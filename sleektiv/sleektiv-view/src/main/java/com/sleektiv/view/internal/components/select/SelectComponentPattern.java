 ...
 * ***************************************************************************
 */
package com.sleektiv.view.internal.components.select;
...
public final class SelectComponentPattern extends FieldComponentPattern {
    ...
    public Map<String, String> getValuesMap(final Locale locale) {
        ...
        if (!isRequired() || (getFieldDefinition() != null && getFieldDefinition().getDefaultValue() == null)) {
            String coreBlankTranslationKey = "sleektivView.form.blankComboBoxValue";
            if (isRequired()) {
                coreBlankTranslationKey = "sleektivView.form.requiredBlankComboBoxValue";
            }
            values.put("",
