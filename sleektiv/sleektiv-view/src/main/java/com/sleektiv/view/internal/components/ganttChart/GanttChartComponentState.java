 ...
 * ***************************************************************************
 */
package com.sleektiv.view.internal.components.ganttChart;
...
import com.sleektiv.view.api.components.ganttChart.GanttChartItem;
import com.sleektiv.view.api.components.ganttChart.GanttChartItemResolver;
import com.sleektiv.view.api.components.ganttChart.GanttChartItemStrip.Orientation;
import com.sleektiv.view.internal.components.ganttChart.GanttChartScaleImpl.ZoomLevel;
...
public class GanttChartComponentState extends AbstractComponentState {
    ...
    protected String translate(final String suffix, final String... args) {
        return getTranslationService().translate(getTranslationPath() + "." + suffix, "sleektivView.gantt." + suffix, getLocale(),
                args);
    }
