 ...
 * ***************************************************************************
 */
package com.sleektiv.view.internal.components.lookup;
...
import com.sleektiv.view.api.ribbon.RibbonActionItem.Type;
import com.sleektiv.view.constants.SleektivViewConstants;
import com.sleektiv.view.internal.*;
...
import com.sleektiv.view.internal.internal.ViewDefinitionImpl;
import com.sleektiv.view.internal.ribbon.model.*;
...
public class LookupComponentPattern extends FieldComponentPattern {
    ...
    protected JSONObject getJsOptions(final Locale locale) throws JSONException {
        ...
        translations.put(
                "noMatchError",
                getTranslationService().translate(getTranslationPath() + ".noMatchError", "sleektivView.lookup.noMatchError",
                        locale));
        translations.put(
                "moreTahnOneMatchError",
                getTranslationService().translate(getTranslationPath() + ".moreTahnOneMatchError",
                        "sleektivView.lookup.moreTahnOneMatchError", locale));
        translations.put(
                "noResultsInfo",
                getTranslationService().translate(getTranslationPath() + ".noResultsInfo", "sleektivView.lookup.noResultsInfo",
                        locale));
        translations.put(
                "tooManyResultsInfo",
                getTranslationService().translate(getTranslationPath() + ".tooManyResultsInfo",
                        "sleektivView.lookup.tooManyResultsInfo", locale));
    ...
    private GridComponentPattern createGridComponentPattern(final ViewDefinition lookupViewDefinition,
        ...
        gridComponentDefinition.setName(SleektivViewConstants.L_GRID);
        ...
        gridComponentDefinition.setReference(SleektivViewConstants.L_GRID);
    ...
    private WindowComponentPattern createWindowComponentPattern(final ViewDefinition lookupViewDefinition) {
        ...
        windowComponentDefinition.setName(SleektivViewConstants.L_WINDOW);
