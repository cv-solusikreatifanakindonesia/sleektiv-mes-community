 ...
 * ***************************************************************************
 */
package com.sleektiv.view.internal.components.tree;

import static com.sleektiv.model.api.types.TreeType.NODE_NUMBER_FIELD;
...
import com.sleektiv.model.api.EntityTreeNode;
...
import com.sleektiv.model.api.utils.TreeNumberingServiceImpl;
...
public final class TreeComponentState extends FieldComponentState implements TreeComponent {
    ...
    public Object getFieldValue() {
        ...
        if (treeStructure.length() > 1) {
            addMessage("sleektivView.validate.field.error.multipleRoots", MessageType.FAILURE);
            return null;
        }
    ...
    /*
     * (non-Javadoc)
     * @see com.sleektiv.view.components.tree.ITreeComponentState#getSelectedEntityId()
     */
    @Override
