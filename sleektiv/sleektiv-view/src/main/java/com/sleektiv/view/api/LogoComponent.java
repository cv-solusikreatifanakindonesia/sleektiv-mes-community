package com.sleektiv.view.api;

import com.sleektiv.view.constants.ApplicationProfile;
import com.sleektiv.view.utils.ViewParametersAppender;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;

import static com.sleektiv.view.constants.ApplicationProfile.*;

@Component
public class LogoComponent {

    private final static String L_DEFAULT_LOGO_BASE_PATH = "/sleektivView/public/css/core/images/login/new/";

    private final static String L_MENU_LOGO_BASE_PATH = "/sleektivView/public/css/core/menu/images-new/";
