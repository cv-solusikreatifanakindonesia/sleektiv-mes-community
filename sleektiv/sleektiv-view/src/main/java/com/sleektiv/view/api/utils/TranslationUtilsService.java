 ...
 * ***************************************************************************
 */
package com.sleektiv.view.api.utils;
...
public class TranslationUtilsService {
    ...
    public String getCategoryTranslation(final Entity category, final Locale locale) {
        return translationService.translate(
                category.getStringField(L_PLUGIN_IDENTIFIER) + L_MENU + category.getStringField(L_NAME), "sleektivView.menu."
    ...
    public String getItemTranslation(final Entity item, final Locale locale) {
        ...
        return translationService.translate(
                ...
                "sleektivView.menu." + categoryEntity.getStringField(L_NAME) + '.' + item.getStringField(L_NAME), locale);
    }
