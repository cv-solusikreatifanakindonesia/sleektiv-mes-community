...
import com.sleektiv.view.internal.components.HiddenComponentPattern;
import com.sleektiv.view.internal.components.layout.GridLayoutCell;
import com.sleektiv.view.internal.components.layout.GridLayoutPattern;
...
public class FormComponentPattern extends AbstractContainerPattern {
    ...
    private void addTranslation(final JSONObject translation, final String key, final Locale locale) throws JSONException {
        translation.put(key, getTranslationService()
                .translate(getTranslationPath() + "." + key, "sleektivView.form." + key, locale));
    }
