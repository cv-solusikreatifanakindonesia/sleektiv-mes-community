...
import com.sleektiv.view.internal.FileAccessService;
...
public final class FileAccessController {
    ...
    private static final String L_FILE_ACCESS_ERROR_HEADER = "sleektivView.errorPage.error.fileAccessError.header";

    private static final String L_FILE_ACCESS_ERROR_EXPLANATION = "sleektivView.errorPage.error.fileAccessError.explanation";

    private static final String L_FILE_NOT_EXISTS_ERROR_HEADER = "sleektivView.errorPage.error.fileNotExistsError.header";

    private static final String L_FILE_NOT_EXISTS_ERROR_EXPLANATION = "sleektivView.errorPage.error.fileNotExistsError.explanation";
    ...
    private void setFileAccessErrorPage(final ModelAndView modelAndView, final Locale locale, final String errorHeader, final String errorExplanation) {
        ...
        modelAndView.setViewName("sleektivView/fileAccessError");
    }
