 ...
 * ***************************************************************************
 */
package com.sleektiv.view.internal.components.form;

import com.google.common.collect.Maps;
import com.sleektiv.model.api.*;
import com.sleektiv.model.api.expression.ExpressionUtils;
import com.sleektiv.model.api.validators.ErrorMessage;
import com.sleektiv.model.internal.DetachedEntityTreeImpl;
...
import com.sleektiv.view.internal.FieldEntityIdChangeListener;
...
import com.sleektiv.view.internal.components.lookup.LookupComponentState;
import com.sleektiv.view.internal.components.tree.TreeComponentState;
import com.sleektiv.view.internal.states.AbstractContainerState;
...
public class FormComponentState extends AbstractContainerState implements FormComponent {
    ...
    /*
     * (non-Javadoc)
     * @see com.sleektiv.view.components.form.EntityComponentState#getEntityId()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.sleektiv.view.components.form.EntityComponentState#getEntity()
     */
    @Override
        ...
        public void save(final String[] args) {
            ...
            if (entity.isValid()) {
                try {
                    ...
                    entity.addGlobalError("sleektivView.errorPage.error.constraintViolationException.explanation");
                    entity.setNotValid();
                }
