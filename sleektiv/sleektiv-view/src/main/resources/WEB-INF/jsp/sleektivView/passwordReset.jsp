...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet"
            ...
            type="text/css"/>
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/sleektivView/public/css/core/passwordReset-min.css?ver=${buildNumber}"
            type="text/css"/>
        ...
        <script type="text/javascript"
            src="${pageContext.request.contextPath}/sleektivView/public/js/core/passwordReset-min.js?ver=${buildNumber}"></script>
    </head>
