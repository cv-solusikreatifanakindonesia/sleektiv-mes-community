...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet"
            ...
            type="text/css"/>
        <link rel="stylesheet"
            href="${pageContext.request.contextPath}/sleektivView/public/css/core/passwordChange-min.css?ver=${buildNumber}"
            type="text/css"/>
        ...
        <script type="text/javascript"
            src="${pageContext.request.contextPath}/sleektivView/public/js/core/qcd/utils/serializator.js?ver=${buildNumber}"></script>
        <script type="text/javascript"
            src="${pageContext.request.contextPath}/sleektivView/public/js/core/passwordChange-min.js?ver=${buildNumber}"></script>
    </head>
