...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/sleektivView/public/css/core/lib/imageviewer.css?ver=${buildNumber}" type="text/css" />
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/lib/imageviewer.min.js?ver=${buildNumber}"></script>

        <link href="${pageContext.request.contextPath}/sleektivView/public/img/core/icons/favicon.png" rel="shortcut icon" />
            ...
            jQuery(document).ready(function() {
                ...
                if (imagePreview || viewerJsPreview) {
                    ...
                    if (imagePreview) {
                        ...
                        var iframeViewerUrlPrefix = "/sleektivView/public/ViewerJS/index.htm#../../../..";
