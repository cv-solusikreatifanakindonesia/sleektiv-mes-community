    ...
    <head>
        ...
        <c:choose>
            <c:when test="${useCompressedStaticResources}">
                ...
                <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/lib/jquery-ui-1.8.5.custom.min.js?ver=${buildNumber}"></script>
                ...
                <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/qcd/alert/packaged/jquery.noty.packaged.min.js?ver=${buildNumber}"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/qcd/alert/layouts/top.min.js?ver=${buildNumber}"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/qcd/alert/layouts/center.min.js?ver=${buildNumber}"></script>

                <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/qcd/alert/notyController.min.js?ver=${buildNumber}"></script>
            ...
            <c:otherwise>
                ...
                <link rel="stylesheet" href="${pageContext.request.contextPath}/sleektivView/public/css/core/sleektiv-min.css?ver=${buildNumber}" type="text/css" />
                <link rel="stylesheet" href="${pageContext.request.contextPath}/sleektivView/public/css/core/mainPage.css?ver=${buildNumber}" type="text/css" />
                <link rel="stylesheet" href="${pageContext.request.contextPath}/sleektivView/public/css/core/menuTopLevel.css?ver=${buildNumber}" type="text/css" />
                ...
                <link rel="stylesheet" href="${pageContext.request.contextPath}/sleektivView/public/css/core/jqModal.css?ver=${buildNumber}" type="text/css" />
                <link rel="stylesheet" href="${pageContext.request.contextPath}/sleektivView/public/css/core/alert/animate.css?ver=${buildNumber}" type="text/css" />
                ...
                <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/lib/jqModal.js?ver=${buildNumber}"></script>
                ...
                <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/qcd/menu/model.js?ver=${buildNumber}"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/qcd/menu/menuController.js?ver=${buildNumber}"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/qcd/core/windowController.js?ver=${buildNumber}"></script>
                ...
                <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/lib/highlight.js?ver=${buildNumber}"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/lib/liveUpdate.js?ver=${buildNumber}"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/sleektivView/public/js/core/lib/jquery.menu-aim.js?ver=${buildNumber}"></script>
        ...
        <script type="text/javascript">
            ...
            window.addMessage = function(message) {
                message.closerTitle = window.translationsMap['sleektivView.notification.closerTitle'];
                message.closeAllTitle = window.translationsMap['sleektivView.notification.closeAllTitle'];
        ...
        <div id="mainTopMenu" class="pageTopHeader clearfix">
            ...
            <div class="logoDropdownBox">
                <div class="logoDropdownBoxToggle">
                    <div class="logo">
                        <img src="${logoPath}" class="logoDark" alt="sleektiv MES logo" onclick="windowController.goToDashboard()">
                        <img src="${logoWhitePath}" class="logoWhite" alt="sleektiv MES logo" onclick="windowController.goToDashboard()">
                    </div>
                    <a href="#" class="arrow"">
                        <i></i>
                    </a>
                ...
                <ul>
                    ...
                    <li><i class="icon iconUser"></i> <a href='#' id="profileButton" onclick="windowController.goToMenuPosition('administration.profile')">${userLogin}</a>
                        <div class="userMenuDropdown">
                            ...
                            <ul>
                                <li>
                                    <a href='#' onclick="windowController.performLogout()"><i class="icon iconLogout"></i>${commonTranslations["sleektivView.button.logout"] }</a>
                                </li>
                            </ul>
                        </div>
                    </li>
