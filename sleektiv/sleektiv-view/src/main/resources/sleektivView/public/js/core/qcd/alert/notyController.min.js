...
QCD.Notifications = function () {
                ...
                $.get('/rest/activityStream', function(data) {
                    if (data instanceof Array) {
                        if (data.length > 0) {
                            ...
                            $('.activityStreamContainer').html('<p class="activityStreamPlaceholder">No new activities.</p>');
                        }
                    }
                });
	...
	this.getNotifications = function (dbNotificationsEnabled, systemNotificationsEnabled, systemNotificationsIntervalInSeconds) {
        var audio = new Audio('/sleektivView/public/alarm.mp3');
                ...
                $.get('/rest/alert', function(data) {
                    if (data instanceof Array) {
                        for (var k in data) {
                            ...
                            if (data[k].sound) {
                                $('#audio').remove();
                                $('body').append('<audio autoplay id="audio"><source src="/sleektivView/public/alarm.mp3"></audio>');
                            }
                        }
                    }
                });
