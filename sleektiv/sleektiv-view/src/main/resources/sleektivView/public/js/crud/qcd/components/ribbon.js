...
QCD.components.Ribbon = function(_model, _elementName, _mainController, _translations) {
	...
	function createBigButtonWithDropdown(path, itemModel) {
		...
		var className = "";
		if (icon) {
			style = " style=\"background-image:url(\'/sleektivView/public/img/core/icons/"+icon+"\')\"";
			className = " hasIcon";
		}
	...
	function getItemIconStyle(itemModel) {
		...
		var style = "";
		if (icon) {
			style = " class='iconElement hasIcon' style=\"background-image:url(\'/sleektivView/public/img/core/icons/"+icon+"\')\"";
		} else {
		...
		var jsObject = {
			...
			setIcon: function(icon) {
				...
				if (icon) {
					...
					iconEl.css("backgroundImage", "url(\'/sleektivView/public/img/core/icons/"+icon+"\')");
				} else {
