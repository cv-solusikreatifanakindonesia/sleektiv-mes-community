...
import com.sleektiv.localization.internal.ConfigUtil;
import com.sleektiv.localization.internal.TranslationModuleService;
...
public class TranslationModule extends Module implements TranslationPropertiesHolder {
    ...
    private String findPluginPath(String pluginIdentifier) {
        List<String> prefixes = Arrays.asList("/mes/mes-plugins/", "/mes-commercial/", "/sleektiv/");
