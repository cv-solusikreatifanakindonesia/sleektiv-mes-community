...
import static com.sleektiv.security.constants.SleektivSecurityConstants.ROLE_ADMIN;
import static com.sleektiv.security.constants.SleektivSecurityConstants.ROLE_SUPERADMIN;
import static com.sleektiv.security.constants.SleektivSecurityConstants.ROLE_USER;
...
public class UserRoleValidationServiceTest {
    ...
    private void stubRoleTransition(final String from, final String to) {
        ...
        given(securityService.hasRole(existingUserEntityMock, SleektivSecurityConstants.ROLE_SUPERADMIN)).willReturn(
                SleektivSecurityConstants.ROLE_SUPERADMIN.equals(from));
        ...
        given(securityService.hasRole(userEntityMock, SleektivSecurityConstants.ROLE_SUPERADMIN)).willReturn(
                SleektivSecurityConstants.ROLE_SUPERADMIN.equals(to));
    }
