...
import com.sleektiv.report.internal.util.ReportFormatFactory;
    ...
    public void printGeneratedReport(final ViewDefinitionState viewDefinitionState, final ComponentState state,
        ...
        if (state.getFieldValue() instanceof Long) {
            ...
            if (state instanceof FormComponent) {
                state.addMessage("sleektivView.form.entityWithoutIdentifier", MessageType.FAILURE);
            } else {
                state.addMessage("sleektivView.grid.noRowSelectedError", MessageType.FAILURE);
            }
        }
    }
