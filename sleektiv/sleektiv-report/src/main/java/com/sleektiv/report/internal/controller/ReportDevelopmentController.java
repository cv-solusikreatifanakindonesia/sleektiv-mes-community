...
import com.sleektiv.report.api.ReportService.ReportType;
...
public class ReportDevelopmentController {
    ...
    private boolean isDynamicDataDefinition(final DataDefinition dataDefinition) {
        return dataDefinition.getPluginIdentifier().equals("sleektivModel") && dataDefinition.getName().startsWith("dynamic");
    }
