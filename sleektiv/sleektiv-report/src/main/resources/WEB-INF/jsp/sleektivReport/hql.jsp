...
<html>
<head>
	<title>SLEEKTIV :: Report Development :: HQL</title>
</head>
<body>

	<h1>Type the HQL query</h1>
	
	<p>Please see the <a href="http://javadoc.sleektiv.org/com/sleektiv/model/api/search/SearchQueryBuilder.html">reference</a>.</p>  
