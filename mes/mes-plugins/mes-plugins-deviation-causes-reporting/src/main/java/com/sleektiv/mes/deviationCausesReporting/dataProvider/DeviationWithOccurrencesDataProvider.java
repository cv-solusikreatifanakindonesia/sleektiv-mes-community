 ...
 * ***************************************************************************
 */
package com.sleektiv.mes.deviationCausesReporting.dataProvider;
...
import com.sleektiv.mes.deviationCausesReporting.constants.DeviationType;
import com.sleektiv.mes.deviationCausesReporting.domain.DeviationCauseHolderComparators;
import com.sleektiv.mes.deviationCausesReporting.domain.DeviationWithOccurrencesCount;
import com.sleektiv.mes.orders.constants.OrderFields;
import com.sleektiv.mes.orders.constants.deviationReasonTypes.DeviationModelDescriber;
...
public class DeviationWithOccurrencesDataProvider {
    ...
    private static final String ALL_PROBLEM_OCCURRENCES_QUERY = "SELECT di.name AS " + CAUSE_ALIAS + ", ("
            ...
            + " FROM #sleektivModel_dictionaryItem AS di WHERE di.dictionary.name = 'reasonTypeOfChangingOrderState'";
