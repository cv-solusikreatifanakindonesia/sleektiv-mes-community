...
import com.sleektiv.mes.orderSupplies.coverage.MaterialRequirementCoverageHelper;
import com.sleektiv.mes.orderSupplies.coverage.MaterialRequirementCoverageService;
...
import com.sleektiv.mes.ordersForSubproductsGeneration.OrdersForSubproductsGenerationService;
import com.sleektiv.mes.ordersForSubproductsGeneration.constants.CoverageForOrderFieldsOFSPG;
import com.sleektiv.mes.ordersForSubproductsGeneration.constants.OrderFieldsOFSPG;
import com.sleektiv.mes.ordersForSubproductsGeneration.constants.SubOrdersFields;
...
public class OrdersForSubproductsGenerationListeners {
    ...
    public final void generateSimpleOrdersForSubProducts(final ViewDefinitionState view, final ComponentState state,
                                                         final String[] args) {
        FormComponent subOrdersForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
        ...
        try {
            ...
            view.addMessage("sleektivView.errorPage.error.internalError.explanation", ComponentState.MessageType.FAILURE);
        } finally {
    ...
    private boolean hasAlreadyGeneratedOrders(final ViewDefinitionState view) {
        FormComponent coverageForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
