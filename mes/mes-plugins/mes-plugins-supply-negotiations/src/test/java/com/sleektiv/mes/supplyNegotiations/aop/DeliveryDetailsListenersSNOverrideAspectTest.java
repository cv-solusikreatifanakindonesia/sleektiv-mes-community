...
import com.sleektiv.mes.deliveries.listeners.DeliveryDetailsListeners;
...
public class DeliveryDetailsListenersSNOverrideAspectTest {
    ...
    public final void checkCreateDeliveredProductExecution() throws NoSuchMethodException {
        ...
        assertEquals("com.sleektiv.mes.deliveries.listeners.DeliveryDetailsListeners", clazz.getCanonicalName());
