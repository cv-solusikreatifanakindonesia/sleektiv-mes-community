...
public class MRCServiceOverideAspect {
    ...
    @Pointcut("execution(public void com.sleektiv.mes.orderSupplies.coverage.MaterialRequirementCoverageServiceImpl.additionalProcessProductCoverage(..)) "
    ...
    @Pointcut("execution(private void com.sleektiv.mes.orderSupplies.coverage.MaterialRequirementCoverageServiceImpl.saveCoverageProduct(..)) "
