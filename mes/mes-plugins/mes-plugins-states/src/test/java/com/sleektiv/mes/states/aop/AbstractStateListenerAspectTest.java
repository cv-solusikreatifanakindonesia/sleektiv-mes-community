...
import com.sleektiv.mes.states.service.client.StateChangeViewClient;
...
public class AbstractStateListenerAspectTest {
    ...
    public final void checkChangeStateExecutionPointcutDefinition() throws NoSuchMethodException {
        ...
        assertEquals("com.sleektiv.mes.states.service.StateChangeService", clazz.getCanonicalName());
    ...
    public final void checkViewClientExecutionPointcutDefinition() throws NoSuchMethodException {
        ...
        assertEquals("com.sleektiv.mes.states.service.client.StateChangeViewClient", clazz.getCanonicalName());
