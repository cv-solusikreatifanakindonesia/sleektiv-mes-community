...
import com.sleektiv.mes.states.exception.StateChangeException;
...
public class AbstractStateChangeAspectTest extends StateChangeTest {
    ...
    public final void checkPrecedencePointcutDefinitions() {
        assertEquals("com.sleektiv.mes.states.aop.StateChangePhaseAspect", StateChangePhaseAspect.class.getCanonicalName());
        assertEquals("com.sleektiv.mes.states.aop.RunInPhaseAspect", RunInPhaseAspect.class.getCanonicalName());
    }
