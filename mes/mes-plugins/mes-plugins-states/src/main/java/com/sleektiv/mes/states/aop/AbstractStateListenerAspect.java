...
public abstract class AbstractStateListenerAspect {
    ...
    /**
     * Pointcut for changing state join points ({@link StateChangeService#changeState(com.sleektiv.mes.states.StateChangeContext)})
     ...
     */
    @Pointcut("execution(public void com.sleektiv.mes.states.service.StateChangeService+.changeState(..)) "
    ...
    @Pointcut("execution(public void com.sleektiv.mes.states.service.client.StateChangeViewClient.changeState(..)) && args(viewContext,..)")
