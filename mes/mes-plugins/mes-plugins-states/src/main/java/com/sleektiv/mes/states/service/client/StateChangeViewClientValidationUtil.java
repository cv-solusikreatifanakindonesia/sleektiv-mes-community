...
import static com.sleektiv.mes.states.messages.constants.MessageFields.CORRESPOND_FIELD_NAME;
import static com.sleektiv.mes.states.messages.constants.StateMessageType.VALIDATION_ERROR;
import static com.sleektiv.mes.states.messages.util.MessagesUtil.convertViewMessageType;
...
import com.sleektiv.mes.states.messages.MessagesHolder;
import com.sleektiv.mes.states.messages.util.MessagesUtil;
import com.sleektiv.mes.states.messages.util.ValidationMessagePredicate;
...
public class StateChangeViewClientValidationUtil {
    ...
    private void addValidationErrorsToForm(final FormComponent form, final Entity entity, final List<Entity> messagesList) {
        ...
        if (!formEntity.isValid()) {
            form.addMessage("sleektivView.message.saveFailedMessage", MessageType.FAILURE);
        }
