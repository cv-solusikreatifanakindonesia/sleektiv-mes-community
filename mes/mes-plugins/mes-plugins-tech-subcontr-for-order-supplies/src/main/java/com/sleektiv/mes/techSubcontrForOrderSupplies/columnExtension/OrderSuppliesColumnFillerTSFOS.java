 ...
 * ***************************************************************************
 */
package com.sleektiv.mes.techSubcontrForOrderSupplies.columnExtension;
...
import com.sleektiv.mes.orderSupplies.print.MaterialRequirementCoverageColumnFiller;
...
public class OrderSuppliesColumnFillerTSFOS implements MaterialRequirementCoverageColumnFiller {
    ...
    private String getStringFromBoolean(final boolean isSubcontractedOrPurchased) {
        return (isSubcontractedOrPurchased) ? translationService.translate("sleektivView.true", LocaleContextHolder.getLocale())
                : translationService.translate("sleektivView.false", LocaleContextHolder.getLocale());
    }
