...
import com.sleektiv.mes.basicProductionCounting.BasicProductionCountingServiceImpl;
import com.sleektiv.mes.basicProductionCounting.constants.ProductionCountingQuantityTypeOfMaterial;
import com.sleektiv.mes.costCalculation.print.dto.TechnologyProduct;
...
import com.sleektiv.mes.costCalculation.print.dto.ComponentsCalculationHolder;
import com.sleektiv.mes.costCalculation.print.dto.CostCalculationMaterial;
import com.sleektiv.mes.costCalculation.print.dto.CostCalculationMaterialBySize;
import com.sleektiv.mes.costNormsForOperation.constants.CalculationOperationComponentFields;
...
import com.sleektiv.report.api.xls.XlsDocumentService;
...
public class CostCalculationXlsService extends XlsDocumentService {
    ...
    private void createCalculationResultsSheet(HSSFSheet sheet, Entity costCalculation, List<Entity> calculationResults,
        ...
        for (Entity calculationResult : calculationResults) {
            ...
            createRegularCell(stylesContainer, row, 25,
                    containsComponents ? translationService.translate("sleektivView.true", locale)
                            : translationService.translate("sleektivView.false", locale));
            rowIndex++;
        }
    ...
    private void createMaterialCostsSheet(List<CostCalculationMaterial> materialCosts, HSSFSheet sheet, Locale locale) {
        ...
        for (CostCalculationMaterial materialCost : materialCosts) {
            ...
            createRegularCell(stylesContainer, row, 3,
                    materialCost.isDifferentProductsInDifferentSizes() ? translationService.translate("sleektivView.true", locale)
                            : translationService.translate("sleektivView.false", locale));
    ...
    private String toYesOrNoFromString(Boolean additionalFinalProducts, Locale locale) {
        return additionalFinalProducts ? translationService.translate("sleektivView.true", locale)
                : translationService.translate("sleektivView.false", locale);
    }
