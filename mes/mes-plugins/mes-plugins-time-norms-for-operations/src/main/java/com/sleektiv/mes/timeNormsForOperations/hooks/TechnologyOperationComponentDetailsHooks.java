...
import static com.sleektiv.mes.timeNormsForOperations.constants.TechnologyOperationComponentFieldsTNFO.*;
...
public class TechnologyOperationComponentDetailsHooks {
    ...
    public void fillUnitFields(final ViewDefinitionState view) {
        ...
        Entity formEntity = ((FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM)).getEntity();
