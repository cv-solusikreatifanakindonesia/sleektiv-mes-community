...
import static com.sleektiv.mes.timeNormsForOperations.constants.TechnologyOperationComponentFieldsTNFO.ALL;
import static com.sleektiv.mes.timeNormsForOperations.constants.TechnologyOperationComponentFieldsTNFO.ARE_PRODUCT_QUANTITIES_DIVISIBLE;
import static com.sleektiv.mes.timeNormsForOperations.constants.TechnologyOperationComponentFieldsTNFO.IS_TJ_DIVISIBLE;
import static com.sleektiv.mes.timeNormsForOperations.constants.TechnologyOperationComponentFieldsTNFO.NEXT_OPERATION_AFTER_PRODUCED_QUANTITY;
import static com.sleektiv.mes.timeNormsForOperations.constants.TechnologyOperationComponentFieldsTNFO.NEXT_OPERATION_AFTER_PRODUCED_TYPE;
import static com.sleektiv.mes.timeNormsForOperations.constants.TechnologyOperationComponentFieldsTNFO.PRODUCTION_IN_ONE_CYCLE;
import static com.sleektiv.mes.timeNormsForOperations.constants.TechnologyOperationComponentFieldsTNFO.SPECIFIED;
import static com.sleektiv.mes.timeNormsForOperations.constants.TimeNormsConstants.FIELDS_OPERATION;
import static com.sleektiv.view.api.ComponentState.MessageType.INFO;
import static com.sleektiv.view.api.ComponentState.MessageType.SUCCESS;
...
public class TechnologyOperCompDetailsListenersTNFO {
    ...
    public void copyTimeNormsFromOperationForTechnologies(final ViewDefinitionState view, final ComponentState componentState,
        ...
        view.addMessage("sleektivView.notification.success", SUCCESS);
    }
    ...
    void applyTimeNormsFromGivenSource(Entity toc, final Entity source) {
        ...
        for (String fieldName : com.sleektiv.mes.timeNormsForOperations.constants.TimeNormsConstants.FIELDS_OPERATION) {
