...
import com.sleektiv.mes.deliveries.print.DeliveryColumnFetcher;
...
public class DeliveryColumnFetcherTSFDOverrideAspectTest {
    ...
    public final void checkCompareProductsExecution() throws NoSuchMethodException {
        ...
        assertEquals("com.sleektiv.mes.deliveries.print.DeliveryColumnFetcher", clazz.getCanonicalName());
