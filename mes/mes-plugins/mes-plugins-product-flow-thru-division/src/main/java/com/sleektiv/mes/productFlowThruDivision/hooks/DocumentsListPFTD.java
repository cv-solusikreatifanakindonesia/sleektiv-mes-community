...
import com.sleektiv.mes.productFlowThruDivision.constants.DocumentDtoFieldsPFTD;
...
public class DocumentsListPFTD {
    ...
    public void setCriteriaModifierParameters(final ViewDefinitionState view) {
        GridComponent documentsGrid = (GridComponent) view.getComponentByReference(SleektivViewConstants.L_GRID);
