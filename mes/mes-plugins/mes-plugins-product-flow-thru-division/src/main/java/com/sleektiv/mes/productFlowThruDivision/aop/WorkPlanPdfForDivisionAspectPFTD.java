...
public class WorkPlanPdfForDivisionAspectPFTD {
    ...
    @Pointcut("execution(private java.util.List<com.sleektiv.model.api.Entity> com.sleektiv.mes.workPlans.pdf.document.WorkPlanPdfForDivision.operationProductOutComponents(..)) "
    ...
    @Pointcut("execution(private java.util.List<com.sleektiv.model.api.Entity> com.sleektiv.mes.workPlans.pdf.document.WorkPlanPdfForDivision.operationProductInComponents(..)) "
            + "&& args(operationComponent)")
