 ...
 * ***************************************************************************
 */
package com.sleektiv.mes.deliveries.states.aop;
...
import com.sleektiv.mes.deliveries.states.aop.listeners.DeliveryStateValidationAspect;
...
public class DeliveryStateValidationAspectTest {
    ...
    public final void shouldBeAnnotatedWithAspectAndRunIfEnabledAnnotations() {
        assertEquals("com.sleektiv.mes.deliveries.states.aop.listeners.DeliveryStateValidationAspect", clazz.getCanonicalName());
