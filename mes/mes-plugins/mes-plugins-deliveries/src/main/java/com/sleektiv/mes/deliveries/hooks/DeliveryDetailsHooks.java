...
import com.sleektiv.mes.deliveries.constants.*;
import com.sleektiv.mes.deliveries.roles.DeliveryRole;
import com.sleektiv.mes.deliveries.states.constants.DeliveryState;
import com.sleektiv.mes.deliveries.states.constants.DeliveryStateChangeFields;
...
public class DeliveryDetailsHooks {
    ...
    private void generateDeliveryNumber(final ViewDefinitionState view) {
        numberGeneratorService.generateAndInsertNumber(view, DeliveriesConstants.PLUGIN_IDENTIFIER, DeliveriesConstants.MODEL_DELIVERY, SleektivViewConstants.L_FORM, DeliveryFields.NUMBER);
    }
    ...
    public void changeFieldsEnabledDependOnState(final ViewDefinitionState view) {
        FormComponent deliveryForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
        FieldComponent stateField = (FieldComponent) view.getComponentByReference(DeliveryFields.STATE);
