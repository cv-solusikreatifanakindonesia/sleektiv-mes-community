...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/sleektivView/public/css/core/notification.css?ver=${buildNumber}"/>
        <c:choose>
        ...
        <script type="text/javascript"
                src="${pageContext.request.contextPath}/sleektivView/public/js/core/lib/moment-with-locales.js?ver=${buildNumber}"></script>
        <script type="text/javascript"
                src="${pageContext.request.contextPath}/sleektivView/public/ChartJS/Chart.min.js?ver=${buildNumber}"></script>
        <script type="text/javascript"
