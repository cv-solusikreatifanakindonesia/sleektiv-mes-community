...
public class StaffService {
    ...
    public void setOwnerCompany(final ViewDefinitionState view) {
        FormComponent staffForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
    ...
    public void generateStaffNumber(final ViewDefinitionState view) {
        numberGeneratorService.generateAndInsertNumber(view, BasicConstants.PLUGIN_IDENTIFIER, BasicConstants.MODEL_STAFF,
                SleektivViewConstants.L_FORM, StaffFields.NUMBER);
    }

    /**
     * @deprecated use com.sleektiv.mes.basic.util.StaffNameExtractor.extractNameAndSurname
     */
    @Deprecated
