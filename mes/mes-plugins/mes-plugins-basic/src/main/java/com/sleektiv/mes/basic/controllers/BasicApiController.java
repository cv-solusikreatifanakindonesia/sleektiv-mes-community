...
import com.sleektiv.mes.basic.ProductService;
...
import com.sleektiv.mes.basic.controllers.dataProvider.DataProvider;
import com.sleektiv.mes.basic.controllers.dataProvider.requests.FaultTypeRequest;
import com.sleektiv.mes.basic.controllers.dataProvider.requests.ProductRequest;
import com.sleektiv.mes.basic.controllers.dataProvider.requests.WorkstationRequest;
import com.sleektiv.mes.basic.controllers.dataProvider.responses.CountriesGridResponse;
import com.sleektiv.mes.basic.controllers.dataProvider.responses.CountriesResponse;
import com.sleektiv.mes.basic.controllers.dataProvider.responses.DataResponse;
import com.sleektiv.mes.basic.controllers.dataProvider.responses.FactoriesResponse;
import com.sleektiv.mes.basic.controllers.dataProvider.responses.FaultTypeResponse;
import com.sleektiv.mes.basic.controllers.dataProvider.responses.ProductResponse;
import com.sleektiv.mes.basic.controllers.dataProvider.responses.ProductsGridResponse;
import com.sleektiv.mes.basic.controllers.dataProvider.responses.SubassembliesResponse;
import com.sleektiv.mes.basic.controllers.dataProvider.responses.WorkstationResponse;
import com.sleektiv.mes.basic.controllers.dataProvider.responses.WorkstationTypesResponse;
...
public final class BasicApiController {
    ...
    public WorkstationResponse saveWorkstation(@RequestBody WorkstationRequest workstation) {
        ...
        if(workstationEntity.isValid()) {
            ...
            if(Objects.nonNull(numberError) && numberError.getMessage().equals("sleektivView.validate.field.error.duplicated")) {
