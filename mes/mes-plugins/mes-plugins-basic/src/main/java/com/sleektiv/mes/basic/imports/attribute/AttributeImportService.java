package com.sleektiv.mes.basic.imports.attribute;
...
public class AttributeImportService {
    ...
    private void addErrorsForContinuous(AttributeImportContainer container, String key, String value, Entity attribute,
        ...
        if ("sleektivView.validate.field.error.invalidNumericFormat".equals(attributeVal
        ...
        } else if ("sleektivView.validate.field.error.invalidScale.max".equals(attributeVal.getError(
