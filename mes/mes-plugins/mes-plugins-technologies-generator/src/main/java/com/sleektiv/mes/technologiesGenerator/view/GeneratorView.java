 ...
 * ***************************************************************************
 */
package com.sleektiv.mes.technologiesGenerator.view;
...
public class GeneratorView {
    ...
    public static GeneratorView from(final ViewDefinitionState view) {
        FormComponent form = view.<FormComponent> tryFindComponentByReference(SleektivViewConstants.L_FORM).orNull();
