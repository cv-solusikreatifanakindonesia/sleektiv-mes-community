...
import com.sleektiv.mes.cmmsMachineParts.plannedEvents.factory.EventFieldsForTypeFactory;
import com.sleektiv.mes.cmmsMachineParts.plannedEvents.fieldsForType.FieldsForType;
import com.sleektiv.mes.cmmsMachineParts.roles.PlannedEventRoles;
...
public class PlannedEventDetailsHooks {
    ...
    public void plannedEventBeforeRender(final ViewDefinitionState view) {
        FormComponent plannedEventForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
