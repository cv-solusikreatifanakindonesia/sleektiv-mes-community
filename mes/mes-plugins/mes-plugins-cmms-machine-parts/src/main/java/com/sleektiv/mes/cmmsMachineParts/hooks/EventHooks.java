...
import com.sleektiv.mes.basic.FaultTypesService;
...
import com.sleektiv.mes.cmmsMachineParts.MaintenanceEventContextService;
import com.sleektiv.mes.cmmsMachineParts.MaintenanceEventService;
import com.sleektiv.mes.cmmsMachineParts.SourceCostService;
import com.sleektiv.mes.cmmsMachineParts.constants.CmmsMachinePartsConstants;
import com.sleektiv.mes.cmmsMachineParts.constants.MaintenanceEventContextFields;
import com.sleektiv.mes.cmmsMachineParts.constants.MaintenanceEventFields;
import com.sleektiv.mes.cmmsMachineParts.constants.MaintenanceEventType;
import com.sleektiv.mes.cmmsMachineParts.constants.ParameterFieldsCMP;
import com.sleektiv.mes.cmmsMachineParts.constants.PlannedEventBasedOn;
...
import com.sleektiv.mes.cmmsMachineParts.roles.EventRoles;
...
public class EventHooks {
    ...
    private static final String L_HIGHEST_PRIORITY = "highestPriority";

    private static final String L_NEW = "01new";
    ...
    public Set<String> fillRowStyles(final Entity event) {
        final Set<String> rowStyles = Sets.newHashSet();

        if (event.getBooleanField(L_HIGHEST_PRIORITY) && L_NEW.equals(event.getStringField(L_STATE))) {
    ...
    private void generateNumber(final ViewDefinitionState view, String modelName, String fieldName) {
        if (numberGeneratorService.checkIfShouldInsertNumber(view, SleektivViewConstants.L_FORM, fieldName)) {
            numberGeneratorService.generateAndInsertNumber(view, CmmsMachinePartsConstants.PLUGIN_IDENTIFIER, modelName,
                    SleektivViewConstants.L_FORM, fieldName);
        }
    }
    ...
    private void toggleOldSolutionsButton(ViewDefinitionState view) {
        WindowComponent windowComponent = (WindowComponent) view.getComponentByReference(SleektivViewConstants.L_WINDOW);
