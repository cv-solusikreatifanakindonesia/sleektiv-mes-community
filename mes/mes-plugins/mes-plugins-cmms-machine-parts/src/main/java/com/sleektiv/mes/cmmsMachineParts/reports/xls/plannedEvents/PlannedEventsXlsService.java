...
import com.sleektiv.mes.cmmsMachineParts.reports.xls.maintenanceEvents.XlsDataType;
import com.sleektiv.mes.cmmsMachineParts.reports.xls.plannedEvents.dto.MachinePartForEventDTO;
import com.sleektiv.mes.cmmsMachineParts.reports.xls.plannedEvents.dto.PlannedEventDTO;
import com.sleektiv.mes.cmmsMachineParts.reports.xls.plannedEvents.dto.PlannedEventRealizationDTO;
import com.sleektiv.mes.cmmsMachineParts.reports.xls.plannedEvents.dto.PlannedEventStateChangeDTO;
import com.sleektiv.mes.cmmsMachineParts.states.constants.PlannedEventStateStringValues;
...
import static com.sleektiv.model.api.BigDecimalUtils.convertNullToZero;
...
public class PlannedEventsXlsService {
    ...
    private String getValue(Object value) {
        if (value == null) {
            return translationService.translate("sleektivView.false", LocaleContextHolder.getLocale());
        }
        if ((Boolean) value) {
            return translationService.translate("sleektivView.true", LocaleContextHolder.getLocale());
        } else {
            return translationService.translate("sleektivView.false", LocaleContextHolder.getLocale());
        }
