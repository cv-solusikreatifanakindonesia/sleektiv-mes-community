...
import com.sleektiv.mes.cmmsMachineParts.criteriaModifiers.EventCriteriaModifiersCMP;
...
public class MaintenanceEventContextService {
    ...
    public void confirmOrChangeContext(ViewDefinitionState view, ComponentState componentState, String[] args) {
        FormComponent formComponent = (FormComponentState) view.getComponentByReference(SleektivViewConstants.L_FORM);
    ...
    private void setEnableOfMainTab(ViewDefinitionState view, boolean enabled) {
        view.getComponentByReference(SleektivViewConstants.L_GRID).setEnabled(enabled);
    }
