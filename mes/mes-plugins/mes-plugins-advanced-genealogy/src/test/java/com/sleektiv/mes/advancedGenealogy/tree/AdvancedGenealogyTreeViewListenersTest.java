...
import com.sleektiv.mes.advancedGenealogy.tree.AdvancedGenealogyTreeViewListeners.FormValidationException;
...
public class AdvancedGenealogyTreeViewListenersTest {
    ...
    public void init() {
        ...
        when(view.getComponentByReference(SleektivViewConstants.L_FORM)).thenReturn(formComponent);
