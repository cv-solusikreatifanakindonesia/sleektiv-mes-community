 ...
 * ***************************************************************************
 */
package com.sleektiv.mes.advancedGenealogy.print;
...
import com.sleektiv.mes.advancedGenealogy.constants.GenealogyReportFields;
...
import com.sleektiv.mes.advancedGenealogy.tree.AdvancedGenealogyTreeService;
...
public class AdvancedGenealogyPdfService extends PdfDocumentService {
    ...
    protected void buildPdfContent(final Document document, final Entity entity, final Locale locale) throws DocumentException {
        ...
        final String documentAuthor = translationService.translate("sleektivReport.commons.generatedBy.label", locale);
    ...
    private PdfPTable createDocumentPanelTable(final Entity entity, final Locale locale) {
        ...
        if (entity.getBooleanField(GenealogyReportFields.INCLUDE_DRAFT)) {
            includeDraft.append(translation.translate("sleektivView.true", locale));
        } else {
            includeDraft.append(translation.translate("sleektivView.false", locale));
        }
        ...
        if (entity.getBooleanField(GenealogyReportFields.DIRECT_RELATED_ONLY)) {
            directRelatedOnly.append(translation.translate("sleektivView.true", locale));
        } else {
            directRelatedOnly.append(translation.translate("sleektivView.false", locale));
        }
