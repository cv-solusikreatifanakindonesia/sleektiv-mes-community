...
import com.sleektiv.mes.orders.constants.WorkstationChangeoverForOperationalTaskFields;
import com.sleektiv.mes.orders.criteriaModifiers.OperationalTaskCriteriaModifiers;
...
public class WorkstationChangeoverForOperationalTaskDetailsHooks {
    ...
    private void setFieldsAndLookups(final ViewDefinitionState view) {
        FormComponent workstationChangeoverForOperationalTaskForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
