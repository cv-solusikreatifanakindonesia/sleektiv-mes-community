...
import com.sleektiv.mes.orders.criteriaModifiers.OperationalTaskDetailsCriteriaModifiers;
...
public class OperationalTasksDetailsHooks {
    ...
    private void fetchNumberFromDatabase(final ViewDefinitionState view) {
        FormComponent operationalTaskForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
    ...
    private void setQuantities(final ViewDefinitionState view) {
        final FormComponent operationalTaskForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
