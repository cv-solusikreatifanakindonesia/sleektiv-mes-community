...
import com.sleektiv.mes.orders.controllers.requests.OrderCreationRequest;
import com.sleektiv.mes.orders.controllers.responses.OrderCreationResponse;
...
public class OrderCreationService {
    ...
    private Entity getCurrentUserProductionLine() {
        Entity currentUser = dataDefinitionService.get(SleektivSecurityConstants.PLUGIN_IDENTIFIER, SleektivSecurityConstants.MODEL_USER)
