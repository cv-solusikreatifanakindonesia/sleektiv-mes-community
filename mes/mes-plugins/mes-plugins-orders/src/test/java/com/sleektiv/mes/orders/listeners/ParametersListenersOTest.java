...
public class ParametersListenersOTest {
    ...
    public void shouldRedirectToDeviationsDictionaryIfDictionaryIdIsntNull() {
        ...
        given(dataDefinitionService.get("sleektivModel", "dictionary")).willReturn(dictionaryDD);
        ...
        String url = "../page/sleektivDictionaries/dictionaryDetails.html?context={\"form.id\":\"" + dictionaryId + "\"}";
