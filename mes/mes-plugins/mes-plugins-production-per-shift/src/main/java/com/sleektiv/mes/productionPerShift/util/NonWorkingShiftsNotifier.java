...
import static com.sleektiv.view.api.ComponentState.MessageType;
...
public class NonWorkingShiftsNotifier {
    ...
    public void checkAndNotify(final ViewDefinitionState view, final DateTime orderStartDateTime,
        ...
        for (FormComponent form : view.<FormComponent> tryFindComponentByReference(SleektivViewConstants.L_FORM).asSet()) {
