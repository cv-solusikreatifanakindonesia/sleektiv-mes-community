...
import com.sleektiv.mes.productionPerShift.BalanceGenerationStrategy;
import com.sleektiv.mes.productionPerShift.ProductionBalancePerShiftGenerator;
import com.sleektiv.mes.productionPerShift.constants.BalanceContextFields;
...
public class GenerateBalanceListeners {
    ...
    public void generateBalance(final ViewDefinitionState viewState, final ComponentState formState, final String[] args) {
        ...
        if (persistedContext.isValid()) {
            // Show 'balances' tab
            WindowComponent window = (WindowComponent) viewState.getComponentByReference(SleektivViewConstants.L_WINDOW);
