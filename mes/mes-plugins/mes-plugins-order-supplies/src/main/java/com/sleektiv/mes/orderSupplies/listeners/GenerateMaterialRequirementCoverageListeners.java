...
import static com.sleektiv.mes.deliveries.constants.DeliveryFields.CURRENCY;
import static com.sleektiv.mes.deliveries.constants.DeliveryFields.EXTERNAL_SYNCHRONIZED;
...
import com.sleektiv.mes.orderSupplies.coverage.coverageAnalysis.CoverageAnalysisForOrderService;
...
import com.sleektiv.mes.orderSupplies.constants.CoverageLocationFields;
...
import com.sleektiv.mes.orderSupplies.constants.CoverageProductSelectedFields;
...
import com.sleektiv.mes.orderSupplies.print.MaterialRequirementCoverageReportPdfService;
...
public class GenerateMaterialRequirementCoverageListeners {
    ...
    public void createRequestForQuotation(final ViewDefinitionState view, final ComponentState state, final String[] args) {
        ...
        // com.sleektiv.mes.orderSupplies.hooks.GenerateMaterialRequirementCoverageHooks.fillRowStylesBasedOnGenerated
