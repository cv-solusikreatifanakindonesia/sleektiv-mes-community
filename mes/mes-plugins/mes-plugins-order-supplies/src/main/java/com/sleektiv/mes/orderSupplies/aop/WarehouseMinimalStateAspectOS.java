 ...
 * ***************************************************************************
 */
package com.sleektiv.mes.orderSupplies.aop;
...
import com.sleektiv.mes.warehouseMinimalState.print.DocumentPdf;
...
public class WarehouseMinimalStateAspectOS {
    ...
    @Pointcut("execution(public boolean com.sleektiv.mes.warehouseMinimalState.WarehouseMinimalStateHelper.checkIfLowerThanMinimum(..)) "
    ...
    @Pointcut("execution(public java.util.Set<java.lang.String> com.sleektiv.mes.materialFlowResources.rowStyleResolvers.WarehouseStocksListResolver.fillRowStyles(..)) "
    ...
    @Pointcut("execution(private void com.sleektiv.mes.warehouseMinimalState.print.DocumentPdf.addAdditionalHeaders(..)) "
    ...
    @Pointcut("execution(private void com.sleektiv.mes.warehouseMinimalState.print.DocumentPdf.addAdditionalCells(..)) "
            + "&& args(table, product)")
    ...
    @Pointcut("execution(private java.util.List<java.lang.Integer> com.sleektiv.mes.warehouseMinimalState.print.DocumentPdf.getHeaderWidths(..))")
