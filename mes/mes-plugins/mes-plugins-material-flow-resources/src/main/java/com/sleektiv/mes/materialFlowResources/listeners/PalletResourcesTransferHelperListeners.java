...
import com.sleektiv.mes.materialFlowResources.service.PalletNumberDisposalService;
...
import static com.sleektiv.view.api.ComponentState.MessageType.FAILURE;
    ...
    private boolean validate(ViewDefinitionState view, List<Entity> dtos) {
        ...
        for (FormComponent form : adl.getFormComponents()) {
            ...
            if (newPalletNumber.getFieldValue() == null) {
                newPalletNumber.addMessage("sleektivView.validate.field.error.missing", FAILURE);
                isValid = false;
                continue;
            }
