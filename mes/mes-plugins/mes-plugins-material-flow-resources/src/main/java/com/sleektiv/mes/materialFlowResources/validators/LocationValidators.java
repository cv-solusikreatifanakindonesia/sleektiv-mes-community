/**
 * ***************************************************************************
 * Copyright (c) 2025 Sleektiv. Project: Sleektiv MES Version: 1.4
 *
 * This file is part of Sleektiv.
 *
 * Sleektiv is free software; you can redistribute it and/or modify it under the terms of the GNU Affero General Public License as published by the Free Software
...
public class LocationValidators {
    ...
    public boolean hasAlgorithm(final DataDefinition dataDefinition, final Entity entity) {
        if (StringUtils.isEmpty(entity.getStringField(LocationFieldsMFR.ALGORITHM))) {
            entity.addError(dataDefinition.getField(LocationFieldsMFR.ALGORITHM), "sleektivView.validate.field.error.missing");
            return false;
        }
