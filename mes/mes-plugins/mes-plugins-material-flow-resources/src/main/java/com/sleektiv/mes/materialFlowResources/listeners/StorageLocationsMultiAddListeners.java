...
import com.sleektiv.mes.materialFlowResources.constants.StorageLocationHelperFields;
...
public class StorageLocationsMultiAddListeners {
    ...
    public void createStorageLocations(final ViewDefinitionState view, final ComponentState state, final String[] args) {
        FormComponent storageLocationHelperForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
