package com.sleektiv.mes.materialFlowResources;

import com.google.common.base.Preconditions;
import com.google.common.base.Strings;
import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.sleektiv.mes.basic.GridResponse;
...
import com.sleektiv.mes.basic.controllers.dataProvider.dto.ProductDTO;
...
import com.sleektiv.mes.materialFlowResources.dto.ColumnProperties;
...
import static com.sleektiv.mes.materialFlowResources.listeners.DocumentsListListeners.MOBILE_WMS;
import static com.sleektiv.mes.materialFlowResources.listeners.DocumentsListListeners.REALIZED;
...
public class DocumentPositionService {
    ...
    public GridResponse<DocumentPositionDTO> findAll(final Long documentId, final String _sidx, final String _sord, final int page,
        ...
        String query = "SELECT %s FROM ( SELECT p.*, p.document_id AS document, product.number AS product, product.name AS productName, product.unit, "
                ...
                + "	LEFT JOIN sleektivsecurity_user u ON (p.pickingworker_id = u.id)\n"
    ...
    private List<Map<String, Object>> getAvailableAdditionalUnitsByProduct(final Map<String, Object> units) {
        ...
        String query = "SELECT convItem.unitto, convItem.quantityto, convItem.quantityfrom, dictItem.isinteger FROM sleektivmodel_unitconversionitem convItem "
                + " JOIN sleektivmodel_dictionaryitem dictItem ON dictItem.name = convItem.unitto "
