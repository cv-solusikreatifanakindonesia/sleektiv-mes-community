package com.sleektiv.mes.materialFlowResources.constants;

public final class StorageLocationDtoFields {
    private StorageLocationDtoFields() {}
    ...
    public static final String RESOURCE_QUANTITY = "resourceQuantity";
    ...
    public static final String PRODUCT_ADDITIONAL_UNIT = "productAdditionalUnit";
