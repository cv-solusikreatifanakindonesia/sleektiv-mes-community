...
import com.sleektiv.mes.assignmentToShift.constants.MultiAssignmentToShiftFields;
...
import com.sleektiv.mes.assignmentToShift.hooks.MultiAssignmentToShiftDetailsHooks;
...
public class MultiAssignmentToShiftListeners {
    ...
    public void addManyWorkers(final ViewDefinitionState view, final ComponentState state, final String[] args) {
        ...
        FormComponent assignmentToShiftForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
