 ...
 * ***************************************************************************
 */
package com.sleektiv.mes.technologies.states.listener;
...
import com.sleektiv.mes.technologies.tree.TechnologyTreeValidationService;
...
public class TechnologyValidationService {
    ...
    private String createMessageForValidationErrors(final String message, final Entity entity) {
        ...
        for (ErrorMessage error : errors) {
            if (!error.getMessage().equals("sleektivView.validate.global.error.custom")) {
                if (addedError) {
