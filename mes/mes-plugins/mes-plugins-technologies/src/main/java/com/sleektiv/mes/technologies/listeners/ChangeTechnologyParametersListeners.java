...
public class ChangeTechnologyParametersListeners {
    ...
    public void changeTechnologyParameters(final ViewDefinitionState view, final ComponentState state, final String[] args)
        ...
        FormComponent changeTechnologyParametersForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
        ...
        if (StringUtils.isNoneEmpty(code) && Objects.isNull(technologyGroupLookup.getFieldValue())) {
            changeTechnologyParametersForm.findFieldComponentByName(ChangeTechnologyParametersFields.TECHNOLOGY_GROUP).addMessage("sleektivView.lookup.noMatchError",
        ...
        try {
            ...
            changeTechnologyParametersForm.findFieldComponentByName(ChangeTechnologyParametersFields.STANDARD_PERFORMANCE)
                    .addMessage("sleektivView.validate.field.error.invalidNumericFormat", ComponentState.MessageType.FAILURE);
