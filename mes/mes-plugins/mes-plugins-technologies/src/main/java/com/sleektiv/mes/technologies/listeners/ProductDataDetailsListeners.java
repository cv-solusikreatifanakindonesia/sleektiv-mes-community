...
import com.sleektiv.mes.technologies.hooks.ProductDataDetailsHooks;
import com.sleektiv.mes.technologies.print.ProductDataPdfService;
...
public class ProductDataDetailsListeners {
    ...
    public void loadProductData(final ViewDefinitionState view, final ComponentState state, final String args[]) {
        FormComponent productDataForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
