 ...
 * ***************************************************************************
 */
package com.sleektiv.mes.technologies.states.aop;
...
import com.sleektiv.mes.technologies.states.constants.TechnologyStateChangeDescriber;
...
public class TechnologyStateChangeAspect extends AbstractStateChangeAspect {
    ...
    public static final String SELECTOR_POINTCUT = "this(com.sleektiv.mes.technologies.states.aop.TechnologyStateChangeAspect)";
