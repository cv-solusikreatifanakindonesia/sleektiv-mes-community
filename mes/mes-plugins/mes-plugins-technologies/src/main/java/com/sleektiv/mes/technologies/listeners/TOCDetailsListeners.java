...
import com.sleektiv.mes.technologies.hooks.TOCDetailsHooks;
import com.sleektiv.mes.technologies.hooks.TechnologyOperationComponentHooks;
...
public class TOCDetailsListeners {
    ...
    public void copyWorkstationsSettingsFromOperation(final ViewDefinitionState view, final ComponentState state, final String[] args) {
        FormComponent technologyOperationComponentForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
