...
public class NegotiationServiceImplTSFNOverrideAspect {
    ...
    @Pointcut("execution(private java.util.List<com.sleektiv.model.api.Entity> com.sleektiv.mes.supplyNegotiations.NegotiationServiceImpl.getCompaniesForNegotiationProduct(..)) "
    ...
    @Pointcut("execution(private com.sleektiv.model.api.Entity com.sleektiv.mes.supplyNegotiations.NegotiationServiceImpl.createRequestForQuotationProduct(..)) "
            + " && args(negotiationProduct)")
