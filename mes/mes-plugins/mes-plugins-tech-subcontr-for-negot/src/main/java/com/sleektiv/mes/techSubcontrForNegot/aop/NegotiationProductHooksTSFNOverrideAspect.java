...
public class NegotiationProductHooksTSFNOverrideAspect {
    ...
    @Pointcut("execution(public boolean com.sleektiv.mes.supplyNegotiations.hooks.NegotiationProductHooks.checkIfNegotiationProductAlreadyExists(..)) "
    ...
    @Pointcut("execution(public void com.sleektiv.mes.supplyNegotiations.hooks.NegotiationProductHooks.updateRequestForQuotationsNumber(..)) "
            + "&& args(negotiationProductDD, negotiationProduct)")
