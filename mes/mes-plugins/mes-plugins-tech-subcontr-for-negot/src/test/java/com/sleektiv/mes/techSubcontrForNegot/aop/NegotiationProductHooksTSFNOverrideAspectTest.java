...
import com.sleektiv.mes.supplyNegotiations.hooks.NegotiationProductHooks;
...
public class NegotiationProductHooksTSFNOverrideAspectTest {
    ...
    public final void checkCheckIfNegotitionProductAlreadyExistsExecution() throws NoSuchMethodException {
        ...
        assertEquals("com.sleektiv.mes.supplyNegotiations.hooks.NegotiationProductHooks", clazz.getCanonicalName());
