...
import com.sleektiv.mes.masterOrders.OrdersFromMOProductsGenerationService;
import com.sleektiv.mes.masterOrders.constants.GeneratingOrdersHelperFields;
import com.sleektiv.mes.masterOrders.constants.MasterOrderPositionDtoFields;
import com.sleektiv.mes.masterOrders.constants.MasterOrdersConstants;
import com.sleektiv.mes.masterOrders.helpers.MasterOrderPositionsHelper;
...
public class MasterOrderPositionsListListeners {
    ...
    public void createOrder(final ViewDefinitionState view, final ComponentState state, final String[] args) {
        GridComponent masterOrderPositionGrid = (GridComponent) view.getComponentByReference(SleektivViewConstants.L_GRID);
