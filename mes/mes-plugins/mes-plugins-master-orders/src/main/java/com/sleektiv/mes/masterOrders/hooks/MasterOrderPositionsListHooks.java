...
public class MasterOrderPositionsListHooks {
    ...
    public void disableButton(final ViewDefinitionState view) {
        GridComponent masterOrderPositionComponent = (GridComponent) view.getComponentByReference(SleektivViewConstants.L_GRID);
        ...
        generateOrders.setMessage("sleektivView.ribbon.orders.generateOrders.message");
