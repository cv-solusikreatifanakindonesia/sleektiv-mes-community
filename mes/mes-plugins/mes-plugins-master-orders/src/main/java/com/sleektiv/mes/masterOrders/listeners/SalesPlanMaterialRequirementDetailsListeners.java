...
import com.sleektiv.mes.masterOrders.constants.DeliveryFieldsMO;
...
import com.sleektiv.mes.masterOrders.constants.SalesPlanMaterialRequirementProductFields;
import com.sleektiv.mes.masterOrders.helpers.SalesPlanMaterialRequirementHelper;
...
public class SalesPlanMaterialRequirementDetailsListeners {
    ...
    public void generateSalesPlanMaterialRequirement(final ViewDefinitionState view, final ComponentState state,
            final String[] args) {
        FormComponent salesPlanMaterialRequirementForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
    ...
    private boolean validateSalesPlanMaterialRequirement(final FormComponent salesPlanMaterialRequirementForm,
        ...
        if (Objects.isNull(salesPlan)) {
            salesPlanLookup.addMessage("sleektivView.validate.field.error.missing", ComponentState.MessageType.FAILURE);
