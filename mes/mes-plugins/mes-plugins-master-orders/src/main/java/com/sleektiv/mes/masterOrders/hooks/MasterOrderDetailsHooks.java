...
import static com.sleektiv.mes.masterOrders.constants.MasterOrderFields.ADD_MASTER_PREFIX_TO_NUMBER;
import static com.sleektiv.mes.masterOrders.constants.MasterOrderFields.NUMBER;
...
import com.sleektiv.mes.masterOrders.criteriaModifier.OrderCriteriaModifier;
...
public class MasterOrderDetailsHooks {
    ...
    private void toggleGenerateOrdersButton(final ViewDefinitionState view) {
        ...
        generateOrdersRibbonActionItem.setMessage("sleektivView.ribbon.orders.generateOrders.message");
    ...
    private boolean checkIfShouldInsertNumber(final ViewDefinitionState state) {
        FormComponent masterOrderForm = (FormComponent) state.getComponentByReference(SleektivViewConstants.L_FORM);
