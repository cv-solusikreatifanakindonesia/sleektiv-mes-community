package com.sleektiv.mes.productionCounting.xls;
...
import com.sleektiv.mes.productionCounting.constants.OrderBalanceFields;
import com.sleektiv.mes.productionCounting.constants.ProductionBalanceFields;
import com.sleektiv.mes.productionCounting.constants.ProductionCountingConstants;
import com.sleektiv.mes.productionCounting.xls.dto.*;
...
public class ProductionBalanceXlsService extends XlsDocumentService {
    ...
    private String toYesOrNoFromString(final String additionalFinalProducts, final Locale locale) {
        return !Strings.isNullOrEmpty(additionalFinalProducts) ? translationService.translate("sleektivView.true", locale)
