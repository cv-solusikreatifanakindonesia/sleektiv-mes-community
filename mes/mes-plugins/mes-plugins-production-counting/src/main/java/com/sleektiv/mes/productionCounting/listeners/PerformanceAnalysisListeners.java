...
import com.sleektiv.mes.productionCounting.constants.PerformanceAnalysisDetailsDtoFields;
import com.sleektiv.mes.productionCounting.constants.PerformanceAnalysisDtoFields;
...
public class PerformanceAnalysisListeners {
    ...
    public void showDetails(final ViewDefinitionState view, final ComponentState state, final String[] args) {
        ...
        GridComponent performanceAnalysisGrid = (GridComponent) view.getComponentByReference(SleektivViewConstants.L_GRID);
