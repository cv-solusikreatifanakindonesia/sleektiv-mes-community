...
import com.sleektiv.mes.productionCounting.constants.TrackingOperationProductInComponentDtoFields;
...
public class TrackingOperationProductInComponentDetailsHooks {
    ...
    public void onBeforeRender(final ViewDefinitionState view) {
        ...
        FormComponent trackingOperationProductInComponentForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
