...
import com.sleektiv.mes.productionCounting.utils.StaffTimeCalculator;
...
public class ProductionTrackingDetailsListeners {
    ...
    public void copyPlannedQuantityToUsedQuantity(final ViewDefinitionState view, final ComponentState state,
                                                  final String[] args) {
        FormComponent productionRecordForm = (FormComponent) view.getComponentByReference(SleektivViewConstants.L_FORM);
