 ...
 * ***************************************************************************
 */
package com.sleektiv.mes.productionCounting.states.listener;
...
import com.sleektiv.mes.basicProductionCounting.constants.*;
import com.sleektiv.mes.materialFlowResources.PalletValidatorService;
...
import com.sleektiv.mes.productionCounting.utils.OrderClosingHelper;
...
import static com.sleektiv.mes.basicProductionCounting.constants.BasicProductionCountingFields.ORDER;
import static com.sleektiv.mes.orders.constants.OrderFields.STATE;
import static com.sleektiv.mes.orders.states.constants.OrderState.COMPLETED;
import static com.sleektiv.mes.states.messages.util.MessagesUtil.getArgs;
import static com.sleektiv.mes.states.messages.util.MessagesUtil.getKey;
        ...
        if (parameter.getBooleanField(ParameterFieldsPC.VALIDATE_PRODUCTION_RECORD_TIMES)
            ...
            if (Objects.isNull(machineTime) || machineTime == 0) {
                productionTracking.addError(productionTracking.getDataDefinition()
                        .getField(ProductionTrackingFields.MACHINE_TIME), "sleektivView.validate.field.error.missing");
            }
