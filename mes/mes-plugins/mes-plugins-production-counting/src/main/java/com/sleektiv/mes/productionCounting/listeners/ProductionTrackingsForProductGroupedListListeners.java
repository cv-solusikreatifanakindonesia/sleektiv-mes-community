...
import com.sleektiv.mes.productionCounting.constants.ProductionTrackingForProductGroupedDtoFields;
...
public class ProductionTrackingsForProductGroupedListListeners {
    ...
    public void showProductionTrackingsForProduct(final ViewDefinitionState view, final ComponentState state, final String[] args) {
        GridComponent productionTrackingsForProductGroupedGrid = (GridComponent) view.getComponentByReference(SleektivViewConstants.L_GRID);
