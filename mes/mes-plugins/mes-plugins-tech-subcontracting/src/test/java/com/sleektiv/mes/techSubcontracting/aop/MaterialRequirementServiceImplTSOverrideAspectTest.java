...
import com.sleektiv.mes.materialRequirements.MaterialRequirementServiceImpl;
...
public class MaterialRequirementServiceImplTSOverrideAspectTest {
    ...
    public final void checkGetDefaultMrpAlgorithmExecution() throws NoSuchMethodException {
        ...
        assertEquals("com.sleektiv.mes.materialRequirements.MaterialRequirementServiceImpl", clazz.getCanonicalName());
