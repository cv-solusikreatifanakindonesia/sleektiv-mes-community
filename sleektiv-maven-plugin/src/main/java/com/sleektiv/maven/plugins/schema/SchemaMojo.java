 ...
 * ***************************************************************************
 */
package com.sleektiv.maven.plugins.schema;
...
public class SchemaMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        try {
            ...
            copySchemaFiles(ignoreWithoutVersion, version, "*/src/main/resources/com/sleektiv/*/*.xsd", workingDirectory);
            copySchemaFiles(ignoreWithoutVersion, version, "*/src/main/resources/com/sleektiv/*/modules/*.xsd",
                    modulesWorkingDirectory);
            copySchemaFiles(ignoreWithoutVersion, version, "*/src/main/resources/com/sleektiv/*/common/*.xsd",
                    commonWorkingDirectory);
            // Temporary
            copySchemaFiles(ignoreWithoutVersion, version, "*/src/main/resources/com/sleektiv/view/view/components/*.xsd",
